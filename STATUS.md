...
**Current release**: 0.1.25 (2026-06-30). The CLI is daily-usable end-to-end and the MCP server is production-ready (41 tools) against Claude Desktop / Claude Code / Kiro / Gemini CLI. v0.1.25 wires static config `[variables]` into note scaffolding (#238 tier 3) — custom templates can reference vault-wide `{{variables}}` from `config.toml`; interactive `[variables.prompt]` is the next slice. It also ships the new mdBook **documentation site** (<https://agustinvalencia.github.io/cuaderno>). Earlier: v0.1.24 (`--json` show verbs, closing #227 — every read+write verb honours `--json`), v0.1.23 (`--json` standalone write commands), v0.1.22/0.1.21/0.1.20 (`--json` write results / list verbs / search), v0.1.19 (portfolio↔project links #253), v0.1.18 (#230/#248), v0.1.17 (#236), v0.1.16 (#242/#244/#245). See [`CHANGELOG.md`](CHANGELOG.md) for the full list.
