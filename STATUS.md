...
| **5 — Tauri UI** | `cdno-tauri` backend, React frontend (Tailwind v4 + shadcn-style, Recharts), Home / Weekly / Commitments views | In progress — M0 (#311), M1 (scaffold, #53) and M2 (Home interactions, #54) done: the app is daily-usable (orient, start, tick, inline state edit); next M3 global capture; shadcn-style primitives deliberately not vendored until first overlay need (M5) |
